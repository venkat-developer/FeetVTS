...
var reportconfig;
     ...
     * @author subramaniam
     */
    $W.AlertSearchToolBar = function(el, oArgs) {
        this.elBase = el;
   ...
   $W.AlertSearchToolBar.setAlertDataTable=function(elreport,config){
	   reportel=elreport;
	   reportconfig=config;
    ...
    $L.augmentObject($W.AlertSearchToolBar, {
        DEFAULT_KEY_SEARCH: "name",
        EVT_ON_ASSIGN_VEHICLE: "assignVehicle"
    });
    // $L.extend($W.SearchToolBar, $W.GroupedReport);
    $L.augmentProto($W.AlertSearchToolBar, $YU.EventProvider);
    $L.augmentObject($W.AlertSearchToolBar.prototype, {
        /**
        ...
        init: function(el, oArgs) {
            ...
            this._searchKey = $W.AlertSearchToolBar.DEFAULT_KEY_SEARCH;
            if (oArgs.searchkey) {
            ...
            $W.Buttons.addDefaultHandler(assignvehicle, function(oArgs){
                this.fireEvent($W.AlertSearchToolBar.EVT_ON_ASSIGN_VEHICLE);
            }, null, this);
            this.configureAttributes();
        },
        configureAttributes: function(){
           this.createEvent($W.AlertSearchToolBar.EVT_ON_ASSIGN_VEHICLE);
        },
       search: function(){
           /* TODO : To Be Handled*/
        	  var oData = {};

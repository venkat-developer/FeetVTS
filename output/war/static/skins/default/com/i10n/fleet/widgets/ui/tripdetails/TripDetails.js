(function() {
    ...
    $L.augmentObject($W.TripDetails.prototype, {
        ...
        onStopTrip: function() {
             ...
             */
            $U.Connect.asyncRequest('GET', '/fleet/form/tripsettings/?command_type=status_type&status=stop&tripId='+tripId+'&tripName='+tripname+'&localTime='+$U.getLocalTime(), this.oCallBacks.stopTrip, null);
        },
        onPauseTrip: function() {
             ...
             * TODO : Change the URL to the proper one once the data providers are exposed
             */
            $U.Connect.asyncRequest('GET', '/fleet/form/tripsettings/?command_type=status_type&status=pause&tripId='+tripId+'&tripName='+tripname, this.oCallBacks.pauseTrip, null);
        },
        onStartTrip: function() {
             ...
             * TODO : Change the URL to the proper one once the data providers are exposed
             */
            $U.Connect.asyncRequest('GET', '/fleet/form/tripsettings/?command_type=status_type&status=start&tripId='+tripId+'&tripName='+tripname, this.oCallBacks.startTrip, null);
        },

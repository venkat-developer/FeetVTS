...
(function() {
     ...
     * @author sabarish
     */
    $W.GroupedReport = function(el, oArgs) {
     ...
     */
    $L.augmentObject($W.GroupedReport, {
        ATTR_GROUP: "group",
        EVT_GROUP_CHANGE: "groupChange"
    });
    $L.extend($W.GroupedReport, $W.Report, {
        /**
        ...
        initAttributes: function(oConfigs) {
            ...
            $W.GroupedReport.superclass.initAttributes.call(this, oConfigs);
            /**
             * @attribute group
             * @description Current Group Selected
             * @type String
             */
            this.setAttributeConfig($W.GroupedReport.ATTR_GROUP, {
                value: null,
        ...
        generatePrintableDataTable: function(elBufferReport) {
            ...
            var sGroupId = this.get($W.GroupedReport.ATTR_GROUP);
    ...
    $L.augmentObject($W.GroupedReport.prototype, {
        /**
        ...
        initGroupedReport: function(el, oArgs) {
            ...
            if (oDataSource instanceof $W.GroupedReport.GroupedDataSource) {
            ...
            $W.GroupedReport.superclass.constructor.call(this, el, oArgs);
            this.subscribe($W.GroupedReport.EVT_GROUP_CHANGE, this._onGroupChange, this, true);
            oDataSource.subscribe($W.GroupedReport.GroupedDataSource.EVT_ON_UPDATE, function(oArgs) {
     ...
     * @param {Object} oData
     */
    $W.GroupedReport.GroupedDataSource = function(oData) {
        this.groupData = oData;
        this.grpData=oData;
        $W.GroupedReport.GroupedDataSource.superclass.constructor.call(this, this.groupSearch);
        this.createEvent($W.GroupedReport.GroupedDataSource.EVT_ON_UPDATE);
    };
    $L.extend($W.GroupedReport.GroupedDataSource, $YU.FunctionDataSource);
    $L.augmentObject($W.GroupedReport.GroupedDataSource, {
        EVT_ON_UPDATE: "onUpdate"
    });
    $L.augmentObject($W.GroupedReport.GroupedDataSource.prototype, {
        /**
        ...
        setGroupData: function(oData) {
            this.groupData = oData;
            this.fireEvent($W.GroupedReport.GroupedDataSource.EVT_ON_UPDATE, oData);
        },
        /**
         * Returns the groupData for the datasource
         */

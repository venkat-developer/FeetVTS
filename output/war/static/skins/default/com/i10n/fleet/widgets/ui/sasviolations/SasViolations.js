        ...
        getDataURL: function() {
            ...
            if (!(oTimeFrame && selectedVehicle)) {
                if (oTimeFrame.startDate && oTimeFrame.endDate) {
                    sResult = "/fleet/view/sas/?module=/blocks/json&data=view&report=sasviolations&localTime="+$U.getLocalTime()+"&startdate=" + oTimeFrame.startDate + "&enddate=" + oTimeFrame.endDate;
                }
                else {
                    sResult = "/fleet/view/sas/?module=/blocks/json&data=view&report=sasviolations&localTime="+$U.getLocalTime();
                }
            }
            else {
                if (oTimeFrame.startDate && oTimeFrame.endDate) {
                    sResult = "/fleet/view/sas/?module=/blocks/json&data=view&report=sasviolations&localTime="+$U.getLocalTime()+"&vehicleId="+selectedVehicle+"&startdate=" + oTimeFrame.startDate + "&enddate=" + oTimeFrame.endDate;
                }
                else {
                    sResult = "/fleet/view/sas/?module=/blocks/json&data=view&report=sasviolations&localTime="+$U.getLocalTime();
                }

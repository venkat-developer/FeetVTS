...
var reportconfig;
     ...
     * @author subramaniam
     */
    $W.SearchToolBar = function(el, oArgs) {
        this.elBase = el;
   ...
   $W.SearchToolBar.setDataTable=function(elreport,config){
	   reportel=elreport;
	   reportconfig=config;
 ...
 $W.SearchToolBar.setMobileDataTable=function(elreport,config){
	   reportel=elreport;
	   reportconfig=config;
    ...
    $L.augmentObject($W.SearchToolBar, {
        DEFAULT_KEY_SEARCH: "name",
        EVT_ON_ASSIGN_VEHICLE: "assignVehicle"
    });
    // $L.extend($W.SearchToolBar, $W.GroupedReport);
    $L.augmentProto($W.SearchToolBar, $YU.EventProvider);
    $L.augmentObject($W.SearchToolBar.prototype, {
        /**
        ...
        init: function(el, oArgs) {
            ...
            this._searchKey = $W.SearchToolBar.DEFAULT_KEY_SEARCH;
            if (oArgs.searchkey) {
            ...
            $W.Buttons.addDefaultHandler(assignvehicle, function(oArgs){
                this.fireEvent($W.SearchToolBar.EVT_ON_ASSIGN_VEHICLE);
            }, null, this);
            this.configureAttributes();
        },
        configureAttributes: function(){
           this.createEvent($W.SearchToolBar.EVT_ON_ASSIGN_VEHICLE);
        },
       search: function(){
           /* TODO : To Be Handled*/
        	  var oData = {};

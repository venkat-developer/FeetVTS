(function() {
     ...
     * @author N.Balaji
     */
    $W.AlertPopUp = function(el, oArgs) {
        /*Declaring Member Properties*/
    	var num1=5;
    	var num2=1;
    	this.elBase = $D.get(el);
        /*Initializing*/
        $W.AlertPopUp.superclass.constructor.call(this, el, oArgs);
        this.attrs = new $YU.AttributeProvider();
        this.configureAttributes();
        this.addListeners();
    };
    $L.augmentObject($W.AlertPopUp, {
        EVT_ON_SUBMIT: "onSubmit",
        EVT_ON_CANCEL: "onCancel"
    });
    $L.extend($W.AlertPopUp, $W.PopUp, {
        /**
        ...
        show: function() {
          ...
          //  elForm.reset();
            $W.AlertPopUp.superclass.show.call(this);
        }
    });
    $L.augmentObject($W.AlertPopUp.prototype, {
        /**
        ...
        configureAttributes: function() {
             ...
             * @type Object
             */
            this.createEvent($W.AlertPopUp.EVT_ON_SUBMIT);
            /**
             * @event onSubmit
             * @description Event is fired when a user clicks on cancel button.
             * @type Object
             */
            this.createEvent($W.AlertPopUp.EVT_ON_CANCEL);
        },
        /**
       ...
       addListeners: function() {
        ...
        onSubmit: function(oArgs) {
            ...
            this.fireEvent($W.AlertPopUp.EVT_ON_SUBMIT, {  
        ...
        onCancel: function(oArgs) {
            ...
            var elForm = $D.getElementsByClassName("dialog-form", null, this.elBase)[0];
           // elForm.reset();
            this.fireEvent($W.AlertPopUp.EVT_ON_CANCEL, {
                formValue: this.getFormValue()
            });

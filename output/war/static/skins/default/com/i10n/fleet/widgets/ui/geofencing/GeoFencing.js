(function(){
	...
	geofencingSaveRegionSubmitted: function(args){
		...
		if(this.regionId != null){
			...
			$U.Connect.asyncRequest("GET", "/fleet/form/geofencing/?command_type=geo_fencing_save&arrayOfLatLngs="
	...
	geofencingSubmitted: function(args){
		...
		$U.Connect.asyncRequest('GET', "/fleet/form/geofencing/?command_type=geo_fencing_add&region-name="+this.regionName
...
//	},
	...
	geofencingCreation: {
		...
		var latlng= new google.maps.LatLng(lat,lng);
			...
			$U.Connect.asyncRequest('GET', "/fleet/form/geofencing/?command_type=geo_fencing_add&arrayOfLatLngs="
	...
	deleteEntity: function(args) {
		...
		if(this.regionIdinAddEntity != null){
			...
			$U.Connect.asyncRequest('GET', "/fleet/form/geofencing/?command_type=geo_fencing_delete&regionID=" + this.regionIdinAddEntity, this.oCallBacks.oDeleteEntityCallBack, null);

		}
		else{
			$U.Connect.asyncRequest('GET', "/fleet/form/geofencing/?command_type=geo_fencing_delete&regionID=" + this.regionId, this.oCallBacks.oDeleteEntityCallBack, null);
		}
	}, 
	/**
...
//		this.displayGeoFencingDetails($D.getAttribute(args.newValue, "item"));
	...
	displayGeoFencingDetails: function(regionID) {
		...
		this.oCallBacks.displayRegion.scope = this;
		$U.Connect.asyncRequest("GET","/fleet/view/controlpanel/?markup=GeoFencingDetails&body=true&regionID=" + regionID, this.oCallBacks.displayRegion, null);
	},
	...
	onMove: function(oEvent, params) {
		...
		$U.Connect.asyncRequest('GET', "/fleet/form/geofencing/?command_type=geo_fencing_edit&regionId="

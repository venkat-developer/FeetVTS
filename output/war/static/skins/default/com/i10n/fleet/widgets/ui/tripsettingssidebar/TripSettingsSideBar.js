(function(){
     ...
     */
    $W.TripSettingsSideBar = function(el, oParams){
        /**
         ...
         */
        this.elTsSideBarContainer = $D.getElementsByClassName("tripsettingssidebar", null, el)[0];
        /**
         * Base Container of the list
         */
        this.elListBaseElement = $D.getElementsByClassName("tripsettings-sidebar", null, el)[0];
        /**
        ...
        /*Initializing*/
        this.initTripSettingsSideBar(this.elTsSideBarContainer, oParams);
    };
    
    $L.augmentObject($W.TripSettingsSideBar, {
        /**
        ...
        listPinComparator: function(el1, el2){
            ...
            if (isEl1Pinned === isEl2Pinned) {
                result = $W.TripSettingsSideBar.listComparator(el1, el2);
            }
            else if (isEl1Pinned) {
                result = -1;
            }
    ...
    /*
     * TripSettingsSideBar extends Minimizable List
     */
    $L.extend($W.TripSettingsSideBar, $W.MinimizableList);
    $L.augmentProto($W.TripSettingsSideBar, $YU.AttributeProvider);
    $L.augmentObject($W.TripSettingsSideBar.prototype, {
        /**
         * The Initialization Function
         */
        initTripSettingsSideBar: function(baseEl, oArgs){
            /*Needed for using the Attribute provider*/
            this.setAttributeConfig($W.TripSettingsSideBar.ATTR_SELECTED_ITEM, {
                value: null
            });
            var el = $D.getElementsByClassName("tripsettings-sidebar", null, baseEl)[0];
            $W.TripSettingsSideBar.superclass.constructor.call(this, baseEl, oArgs);
        ...
        selectItem: function(objectName, selectByID){
            ...
            $D.getElementsByClassName('item', null, this.elTsSideBarContainer, function(target){
                ...
                if (objectName === key) {
                    /*Change the Selected trip attribute value*/
                    originalScope.set($W.TripSettingsSideBar.ATTR_SELECTED_ITEM, target);
        ...
        addToList: function(trip){
            ...
            $D.setAttribute(listChildElement, "item", trip["id"]);
            $D.setAttribute(listChildElement, "itemname", trip["name"]);
            $D.addClass(listChildElement, "slist-item list-item-type item");
        ...
        addEventListeners: function(){
            ...
            $U.addDefaultInputText(this.searchInput, $W.TripSettingsSideBar.DEFAULT_SEARCH_STRING);
        ...
        removeStatusClasses: function(target){
            for (var status in $W.TripSettingsSideBar.TRIP_STATUS) {
                $D.removeClass(target, $W.TripSettingsSideBar.TRIP_STATUS[status]);
            }
        },
        /**
        ...
        sort: function(){
            if (this.pinningEnabled) {
                this.oSortableList.sort($D.getElementsByClassName("item", null, this.oDataContainer), $W.TripSettingsSideBar.listPinComparator);
            }
            else {
                this.oSortableList.sort($D.getElementsByClassName("item", null, this.oDataContainer), $W.TripSettingsSideBar.listComparator);
            }
        },
        /**

(function() {
    ...
    $L.extend($W.DeleteRouteSchedule, $W.DeleteEntity, {
        ...
        reloadList: function() {
            ...
            $U.Connect.asyncRequest('GET', "/fleet/view/controlpanel/?markup=DeleteRouteSchedule&body=true", this.oCallBacks.oReloadListCallBack);
        },
        deleteEntity: function(aKeys) {
			...
			$U.Connect.asyncRequest('GET', "/fleet/form/admin/?command_type=delete_routeschedule&routescheduleList=" + sParams, this.oCallBacks.oDeleteEntityCallBack, null);
		 },

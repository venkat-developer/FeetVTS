(function() {
    ...
    $L.extend($W.EditGroup, $W.EditEntity, {
        ...
        getEntity: function(oKey) {
            ...
            $U.Connect.asyncRequest("GET", "/fleet/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=group&groupID=" + oKey, this.oCallBacks.oGetEntityCallBack, null);
        },
        getSaveURL: function() {
            /*

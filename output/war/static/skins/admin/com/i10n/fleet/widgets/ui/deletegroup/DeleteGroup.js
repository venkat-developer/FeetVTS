(function() {
    ...
    $L.extend($W.DeleteGroup, $W.DeleteEntity, {
        ...
        reloadList: function() {
            ...
            $U.Connect.asyncRequest('GET', "/fleet/view/controlpanel/?markup=DeleteGroup&body=true", this.oCallBacks.oReloadListCallBack);
        },
        deleteEntity: function(aKeys) {
            ...
            $U.Connect.asyncRequest('GET', "/fleet/form/admin/?command_type=delete_group&groupList=" + sParams, this.oCallBacks.oDeleteEntityCallBack, null);
        },
        refresh: function() {
            this.onCancel();

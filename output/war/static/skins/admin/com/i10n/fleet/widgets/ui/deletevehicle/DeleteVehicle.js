(function() {
	...
	reloadList: function() {
		...
		$U.Connect.asyncRequest('GET', "/fleet/view/controlpanel/?markup=DeleteVehicle&body=true", this.oCallBacks.oReloadListCallBack);
	},
	deleteEntity: function(aKeys) {
		...
		$U.Connect.asyncRequest('GET', "/fleet/form/admin/?command_type=delete_vehicle&vehicleList=" + sParams, this.oCallBacks.oDeleteEntityCallBack, null);
	},
	refresh: function() {
		this.onCancel();

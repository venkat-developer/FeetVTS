(function() {
    ...
    $L.extend($W.DeleteUser, $W.DeleteEntity, {
        ...
        reloadList: function() {
            ...
            $U.Connect.asyncRequest('GET', "/fleet/view/controlpanel/?markup=DeleteUser&body=true", this.oCallBacks.oReloadListCallBack);
        },
        deleteEntity: function(aKeys) {
			...
			$U.Connect.asyncRequest('GET', "/fleet/form/admin/?command_type=delete_user&userList=" + sParams, this.oCallBacks.oDeleteEntityCallBack, null);
			//$U.Connect.asyncRequest('GET', "/fleet/view/controlpanel/?userList=" + sParams, this.oCallBacks.oDeleteEntityCallBack, null);
        },
        refresh: function() {
            this.onCancel();

(function() {
    ...
    $L.extend($W.EditVehicle, $W.EditEntity, {
        ...
        getEntity: function(oKey) {
            ...
            $U.Connect.asyncRequest("GET", "/fleet/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=vehicle&vehicleID=" + oKey, this.oCallBacks.oGetEntityCallBack, null);
        },
        getSaveURL: function() {
            /*

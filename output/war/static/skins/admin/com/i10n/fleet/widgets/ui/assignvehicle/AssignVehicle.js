(function() {
    ...
    $L.extend($W.AssignVehicle, $W.Assignment, {
        ...
        saveChanges: function(oInput) {
           ...
           oRequestParams.userId = oInput.userID;
             ...
             */
            $U.Connect.asyncRequest('POST', "/fleet/form/admin/?command_type=assign_vehicle", this.oSaveCallback, $U.MapToParams(oRequestParams));
            /*
    ...
    $L.augmentObject($W.AssignVehicle.prototype, {
        ...
        onUserSelected: function(oEvent, oArgs) {
            ...
            this.sUserID = userID;
            $U.Connect.asyncRequest("GET", "/fleet/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json"+

(function() {
    ...
    $L.extend($W.AssignDriversToGroup, $W.Assignment, {
        ...
        saveChanges: function(oInput) {
           ...
           oRequestParams.groupId = oInput.groupID;
             ...
             */
            $U.Connect.asyncRequest('POST', "/fleet/form/admin/?command_type=assigndriver_group", this.oSaveCallback, $U.MapToParams(oRequestParams));
    ...
    $L.augmentObject($W.AssignDriversToGroup.prototype, {
        ...
        onGroupSelected: function(oEvent, oArgs) {
            ...
            $U.Connect.asyncRequest("GET", "/fleet/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=group&dataView=assignmentdriver&groupID=" + groupID, this.oVehicleDataReceiptCallBack, null);
            /*
             * Preventing possible memory leaks
             */
            groupID = null;

(function() {
    ...
    $L.extend($W.EditUser, $W.EditEntity, {
        ...
        getEntity: function(oKey) {
            ...
            $U.Connect.asyncRequest("GET", "/fleet/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=user&userID=" + oKey, this.oCallBacks.oGetEntityCallBack, null);
        },
        getSaveURL: function() {
            /*

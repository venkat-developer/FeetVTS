(function() {
	...
	$L.extend($W.EditHardware, $W.EditEntity, {
		...
		getEntity: function(oKey) {
			...
			$U.Connect.asyncRequest("GET", "/fleet/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=hardware&hardwareID=" + oKey, this.oCallBacks.oGetEntityCallBack, null);
		},
		getSaveURL: function() {
			/*

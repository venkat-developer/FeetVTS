(function() {
     ...
     * @author N.Balaji
     */
    $W.ReportVehiclePopUp = function(el, oArgs) {
        /*Declaring Member Properties*/
        this.elBase = $D.get(el);
        /*Initializing*/
        $W.ReportVehiclePopUp.superclass.constructor.call(this, el, oArgs);
        this.attrs = new $YU.AttributeProvider();
        this.configureAttributes();
        this.addListeners();
    };
    $L.augmentObject($W.ReportVehiclePopUp, {
        EVT_ON_SUBMIT: "onSubmit",
        EVT_ON_CANCEL: "onCancel"
    });
    $L.extend($W.ReportVehiclePopUp, $W.PopUp, {
        /**
        ...
        show: function() {
            ...
            elForm.reset();
            $W.ReportVehiclePopUp.superclass.show.call(this);
        }
    });
    $L.augmentObject($W.ReportVehiclePopUp.prototype, {
        /**
        ...
        configureAttributes: function() {
             ...
             * @type Object
             */
            this.createEvent($W.ReportVehiclePopUp.EVT_ON_SUBMIT);
            /**
             * @event onSubmit
             * @description Event is fired when a user clicks on cancel button.
             * @type Object
             */
            this.createEvent($W.ReportVehiclePopUp.EVT_ON_CANCEL);
        },
        /**
       ...
       //oRequestParams.userId = oInput.userID;
         ...
         */
        $U.Connect.asyncRequest('POST', "@APP_CONTEXT@/view/controlpanel/?markup=reportsettings", this.oSaveCallback, $U.MapToParams(oRequestParams));
        /*
        ...
        onSubmit: function(oArgs) {
          ...
          //  onSave: function() {
                ...
                this.hide();
                this.fireEvent($W.ReportVehiclePopUp.EVT_ON_SUBMIT);
            }, /**
       ...
       // },
        ...
        onCancel: function(oArgs) {
            ...
            var elForm = $D.getElementsByClassName("dialog-form", null, this.elBase)[0];
            elForm.reset();
            this.fireEvent($W.ReportVehiclePopUp.EVT_ON_CANCEL, {
                formValue: this.getFormValue()
            });
            this.hide();
        }

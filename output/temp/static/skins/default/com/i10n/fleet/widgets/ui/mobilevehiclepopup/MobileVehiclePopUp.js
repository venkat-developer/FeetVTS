(function() {
     ...
     * @author N.Balaji
     */
    $W.MobileVehiclePopUp = function(el, oArgs) {
        /*Declaring Member Properties*/
        this.elBase = $D.get(el);
        /*Initializing*/
        $W.MobileVehiclePopUp.superclass.constructor.call(this, el, oArgs);
        this.attrs = new $YU.AttributeProvider();
        this.configureAttributes();
        this.addListeners();
    };
    $L.augmentObject($W.MobileVehiclePopUp, {
        EVT_ON_SUBMIT: "onSubmit",
        EVT_ON_CANCEL: "onCancel"
    });
    $L.extend($W.MobileVehiclePopUp, $W.PopUp, {
        /**
        ...
        show: function() {
            ...
            elForm.reset();
            $W.MobileVehiclePopUp.superclass.show.call(this);
        }
    });
    $L.augmentObject($W.MobileVehiclePopUp.prototype, {
        /**
        ...
        configureAttributes: function() {
             ...
             * @type Object
             */
            this.createEvent($W.MobileVehiclePopUp.EVT_ON_SUBMIT);
            /**
             * @event onSubmit
             * @description Event is fired when a user clicks on cancel button.
             * @type Object
             */
            this.createEvent($W.MobileVehiclePopUp.EVT_ON_CANCEL);
        },
        /**
       ...
       //oRequestParams.userId = oInput.userID;
         ...
         */
        $U.Connect.asyncRequest('POST', "@APP_CONTEXT@/view/controlpanel/?markup=mobilealertsettings", this.oSaveCallback, $U.MapToParams(oRequestParams));
        /*
        ...
        onSubmit: function(oArgs) {
          ...
          //  onSave: function() {
                ...
                this.hide();
                this.fireEvent($W.MobileVehiclePopUp.EVT_ON_SUBMIT);
            }, /**
       ...
       // },
        ...
        onCancel: function(oArgs) {
            ...
            var elForm = $D.getElementsByClassName("dialog-form", null, this.elBase)[0];
            elForm.reset();
            this.fireEvent($W.MobileVehiclePopUp.EVT_ON_CANCEL, {
                formValue: this.getFormValue()
            });
            this.hide();
        }

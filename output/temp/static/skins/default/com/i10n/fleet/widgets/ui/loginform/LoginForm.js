(function() {
    ...
    /**
     * LoginForm Widget for Fleetcheck project
     *
     * @author sabarish
     */
    $W.LoginForm = function(el, params) {
        ...
        /*this.getTimeUrl: function(){
        	 $U.Connect.asyncRequest("GET", "@APP_CONTEXT@/form/login/?localTime="+ $U.getLocalTime(), this.oCallBacks, null);
        },
        this.oCallBacks: {
        	success: function(o){
        },

...
(function(){
    ...
    $L.augmentObject($W.LogManager.prototype, {
        ...
        updateUsers: function(){
            var userListURL = "@APP_CONTEXT@/view/controlpanel/?markup=adminmanage&subpage=logs&debug=true&module=/blocks/json&data=view";
        ...
        updateIPs: function(event, oArgs){
            ...
            var IPsURL = "@APP_CONTEXT@/view/controlpanel/?markup=adminmanage&subpage=logs&debug=true&module=/blocks/json&data=view&log=ips&userID=";
         ...
         */
        updateLogs: function(){
            var logsURL = "@APP_CONTEXT@/view/controlpanel/?markup=adminmanage&subpage=logs&debug=true&module=/blocks/json&data=view&ip=logs&localTime="+$U.getLocalTime()+"&userID=";

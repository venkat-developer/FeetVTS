(function() {
    ...
    $L.extend($W.DeleteHardware, $W.DeleteEntity, {
        ...
        reloadList: function() {
            ...
            $U.Connect.asyncRequest('GET', "@APP_CONTEXT@/view/controlpanel/?markup=DeleteHardware&body=true", this.oCallBacks.oReloadListCallBack);
        },
        deleteEntity: function(aKeys) {
            ...
            $U.Connect.asyncRequest('GET', "@APP_CONTEXT@/form/admin/?command_type=delete_hardware&hardwareList=" + sParams, this.oCallBacks.oDeleteEntityCallBack, null);
        },
        refresh: function() {
            this.onCancel();

(function() {
    ...
    $L.extend($W.AssignVehiclesToGroup, $W.Assignment, {
        ...
        saveChanges: function(oInput) {
           ...
           oRequestParams.groupId = oInput.groupID;
             ...
             */
            $U.Connect.asyncRequest('POST', "@APP_CONTEXT@/form/admin/?command_type=assign_group", this.oSaveCallback, $U.MapToParams(oRequestParams));
    ...
    $L.augmentObject($W.AssignVehiclesToGroup.prototype, {
        ...
        onGroupSelected: function(oEvent, oArgs) {
            ...
            $U.Connect.asyncRequest("GET", "@APP_CONTEXT@/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=group&dataView=assignment&groupID=" + groupID, this.oVehicleDataReceiptCallBack, null);
            /*
             * Preventing possible memory leaks
             */
            groupID = null;

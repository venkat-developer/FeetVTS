...
(function() {
    ...
    $L.extend($W.EditDriver, $W.EditEntity, {
        ...
        getEntity: function(oKey) {
            ...
            $U.Connect.asyncRequest("GET", "@APP_CONTEXT@/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=driver&driverID=" + oKey, this.oCallBacks.oGetEntityCallBack, null);
        },
        getSaveURL: function() {
            /*

            ...
            var oWrappedCallBack = {
                success: function(o) {
                    if (o.responseText.indexOf("@Page:Login@") >= 0) {
                        window.location = "/fleet/view/login/";
                    }
                    else {
            ...
            switch (state) {
                ...
                case $U.EditableDivBuilder.EDIT_STATE:
                    if ($D.getElementsByClassName("input", null, targetEl)[0] !== null) {
                        ...
                        $U.Connect.asyncRequest('GET', "/fleet/form/tripsettings/?command_type=trip_settings_edit_speed&tripId="+
            ...
            switch (state) {
                ...
                case $U.EditableDivBuilder.EDIT_STATE:
                    if ($D.getElementsByClassName("input", null, targetEl)[0] !== null) {
                        ...
                        $U.Connect.asyncRequest('GET', "/fleet/form/tripsettings/?command_type=trip_settings_edit_idle&tripId="+

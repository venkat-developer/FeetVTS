(function() {
	...
	$L.augmentObject($W.Maps, {
		...
		"MARKER_SPRITE_CONFIG": {
			"vehicles": {
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/blurb/offline.png'	,new $O.Size(20,35), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-1":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/bike/offline.png'		,new $O.Size(39,30), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-2":{
				"idle": new $W.Maps.Icon('/static/img/vehicles/blurb/idle.png'			,new $O.Size(20,35), new $O.Pixel(0,0), new $O.Pixel(-18, -34)),
				"online": new $W.Maps.Icon('/static/img/vehicles/blurb/blurb.png'		,new $O.Size(20,35), new $O.Pixel(0,0), new $O.Pixel(-18, -34)),
			...
			"custom-3":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/busoffline.png'		,new $O.Size(58,63), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-4":{
				"idle": new $W.Maps.Icon('/static/img/vehicles/busidle.png'				,new $O.Size(58,63), new $O.Pixel(0,0), new $O.Pixel(-18, -34)),
			...
			"custom-12":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/car/offline.png'			,new $O.Size(30,20), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-13":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/jeep/offline.png'			,new $O.Size(42,36), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-14":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/jeep1/offline.png'		,new $O.Size(38,29), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-15":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/pointer/offline.png'		,new $O.Size(15,44), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-16":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/tractor/offline.png'		,new $O.Size(40,36), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-17":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/truck/offline.png'		,new $O.Size(40,30), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-18":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/van/offline.png'			,new $O.Size(40,31), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			},
			"custom-19":{
				...
				"offroad": new $W.Maps.Icon('/static/img/vehicles/fueltanker/offline.png'		,new $O.Size(40,50), new $O.Pixel(0,0), new $O.Pixel(-18, -34))
			}
		}
	});
	$L.augmentObject($W.Maps, {
	...
	$W.Maps.FleetInfoWindow = $O.Class({
		...
		addListeners: function(oSelf) {
			...
			$E.addListener($D.getElementsByClassName("info-tbl-location-col", null, this.elBase), "click", function(oArgs, oArgsSelf) {
					var target = oArgs.target;
					var location = target.innerHTML;
					if(location.indexOf(":") != -1){
						var URL = null;
						var latlongs=location.split(":");
		...
		oLocationCallback: {
			...
			document.getElementById("popuplocation").innerHTML =oData.address;
			this.addListeners(this);
		},
		failure: function(o) {
		}
		...
		drawAndMoveTo: function(oArgs) {
			...
			this.draw(oPixel);
			this.panMap();
			//this.setCenter(oArgs.position,8);
			this.display(true);
			this.addListeners(this);
		},
	...
	$W.Maps.addKMLLayers= function(oArgs){
		var kmlLayer = new OpenLayers.Layer.Vector(/*"KML"+*/oArgs.fileName.replace(".kml",""), {
			projection: new OpenLayers.Projection("EPSG:4326"),
			displayProjection: new OpenLayers.Projection("EPSG:4326"),
			strategies: [new OpenLayers.Strategy.Fixed()],
			protocol: new OpenLayers.Protocol.HTTP({
				url: "/kml/"+oArgs.fileName,
				format: new OpenLayers.Format.KML({
					extractStyles: true,
					extractAttributes: true,
					maxDepth: 2
		...
		var kmlSelect = new OpenLayers.Control.SelectFeature(kmlLayer,{autoActivate: true, hover: true,clickout: true, toggle: false, multiple: false,toggleKey: "ctrlKey",  multipleKey: "shiftKey"});

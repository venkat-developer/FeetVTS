(function() {
     ...
     * @author sabarish
     */
    $W.AssignDriver = function(el, oArgs) {
        $W.AssignDriver.superclass.constructor.call(this, el, oArgs);
    ...
    $L.extend($W.AssignDriver, $W.Assignment, {
        ...
        saveChanges: function(oInput) {
             ...
             */
            $U.Connect.asyncRequest('POST', "@APP_CONTEXT@/form/admin/?command_type=assign_driver", this.oSaveCallback, $U.MapToParams(oRequestParams));
            /*
    ...
    $L.augmentObject($W.AssignDriver.prototype, {
        /*Defining call backs*/
        oSaveCallback: {
            success: function(o) {
            },
        ...
        onUserSelected: function(oEvent, oArgs) {
            ...
            this.sUserID = userID;
            $U.Connect.asyncRequest("GET", "@APP_CONTEXT@/view/controlpanel/?markup=AdminManage&debug=true&module=/blocks/json&data=view&subpage=driver&dataView=assignment&userID=" + userID, this.oDriverDataReceiptCallBack, null);
            /*
             * Preventing possible memory leaks
             */
            userID = null;

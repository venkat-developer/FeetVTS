(function() {
     ...
     * @author sabarish
     */
    $W.DeleteFuelCalibration = function(el, oArgs) {
        $W.DeleteFuelCalibration.superclass.constructor.call(this, el, oArgs);
        var oDataSrcEditHardware=[];     
        this.elTEditHardwareContainer = $D.getElementsByClassName("hardware-sel",null,this.elBase)[0];
        this.initDeleteFuelCalibration(el, oArgs);
    };
    $L.extend($W.DeleteFuelCalibration, $W.EditEntity, {
        /*Defining necessary callbacks*/
        oSaveCallback: {
            success: function(o) {
                $D.getElementsByClassName("mesg", null, this.elBase)[0].innerHTML = "<span class='title'>Success:</span> Sample successfully deleted.";
        ...
        getEntity: function(oKey) {
            ...
            var str="<input class='input-element txt' name='hardwareid' value="+hardwareid+" type='hidden'/>";
    ...
    $L.augmentObject($W.DeleteFuelCalibration.prototype, {
        /**
         * The initialization function
         * @param {Object} el The base element
         * @param {Object} oArgs The optional configuration params
         */
        initDeleteFuelCalibration: function(el, oArgs) {
            this.elBase = el;

(function() {
    ...
    /**
     * The vehicle speed graph widget
     *
     * @author Subramaniam
     */
    $W.SpeedGraphReport = function(el, oArgs) {
        $W.SpeedGraphReport.superclass.constructor.call(this, el, oArgs);
    };
    $L.extend($W.SpeedGraphReport, $W.GraphReport, {
        /**
        ...
        getDataURL: function() {
            ...
            if (oTimeFrame && sVehicleId) {
                sResult = "/fleet/view/reports/?debug=true&module=/blocks/json&data=view&vehicleID=" + sVehicleId + "&report=speedgraphreport";

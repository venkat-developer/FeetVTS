    ...
    $L.augmentObject($W.TripSettings.prototype, {
        ...
        */
        ...
        tripSubmitted: function(args){
             ...
             */
            $U.Connect.asyncRequest('GET', "@APP_CONTEXT@/form/tripsettings/?command_type=trip_settings&localTime="+$U.getLocalTime()+"&vacant-vehilce="+vacantVehicle+"&vacant-driver="+vacantDriver+

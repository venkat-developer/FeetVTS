(function(){
     ...
     * @author N.Balaji
     */
    $W.ConfirmationPopUp = function(el, oArgs){
        /*Initializing*/
        this.elBase = $D.get(el);
        $W.ConfirmationPopUp.superclass.constructor.call(this, el, oArgs);
        this.addListeners();
        this.configureAttributes();
    };
    $L.augmentObject($W.ConfirmationPopUp, {
        EVT_ON_CONFIRMATION: "onConfirmation"
    });
    $L.extend($W.ConfirmationPopUp, $W.PopUp);
    $L.augmentProto($W.ConfirmationPopUp, $YU.AttributeProvider);
    $L.augmentObject($W.ConfirmationPopUp.prototype, {
        /**
        ...
        addListeners: function(){
            $W.Buttons.addDefaultHandler($D.getElementsByClassName("yes-button", null, this.elBase), function(e){
                this.fireEvent($W.ConfirmationPopUp.EVT_ON_CONFIRMATION, {
                    "confirmation": true
                });
            }, null, this);
        ...
        configureAttributes: function(){
             ...
             * @type Object
             */
            this.createEvent($W.ConfirmationPopUp.EVT_ON_CONFIRMATION, this);
        }
    });
})();
